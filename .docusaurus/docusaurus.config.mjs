...
export default {
  ...
  "organizationName": "EUDAT-B2HANDLE",
  "projectName": "eudat-b2handle.github.io",
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "/Users/themiszamani/Dropbox (Personal)/B2HANDLE-ORG/documentation/eudat-b2handle.github.io/sidebars.js",
        ...
        "theme": {
          "customCss": "/Users/themiszamani/Dropbox (Personal)/B2HANDLE-ORG/documentation/eudat-b2handle.github.io/src/css/custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2022 B2HANDLE, EUDAT. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
